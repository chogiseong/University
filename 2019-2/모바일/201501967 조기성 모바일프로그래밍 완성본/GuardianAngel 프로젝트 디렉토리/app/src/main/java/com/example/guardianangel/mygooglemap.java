...
public class mygooglemap extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void oneMarker() {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(mygooglemap.this, "눌렀습니다!!", Toast.LENGTH_LONG);
                return false;
            }
        });
    ...
    GoogleMap.OnInfoWindowClickListener infoWindowClickListener = new GoogleMap.OnInfoWindowClickListener() {
        ...
        public void onInfoWindowClick(Marker marker) {
            ...
            Toast.makeText(mygooglemap.this, "정보창 클릭 Marker ID : "+markerId, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    GoogleMap.OnMarkerClickListener markerClickListener = new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            Toast.makeText(mygooglemap.this, "마커 클릭 Marker ID : "+markerId+"("+location.latitude+" "+location.longitude+")", Toast.LENGTH_SHORT).show();
            return false;
        }
    };
